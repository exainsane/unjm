  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
        ...
        $show = mysql_query("SELECT * FROM blog WHERE id='$id'");
                ...
                <div class="x_content">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                      <input type="text" class="form-control" required="required" placeholder="Judul Post" name="judul" value="<?php echo $data['judul']; ?>">
                    </div>
                  </div><br><br><br>
                  <div class="form-group">
