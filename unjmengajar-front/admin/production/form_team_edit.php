  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-table"></i> Tables <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="post.php">Post Blog</a></li>
        ...
        $show = mysql_query("SELECT * FROM team WHERE id='$id'");
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="x_content">
                  <form enctype="multipart/form-data" action="edit_team.php" method="post">
                  <input type="hidden" name="id" value="<?php echo $id; ?>">
                  <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Nama</label>
                    <div class="col-md-9 col-sm-9 col-xs-12">
                      <input type="text" class="form-control" required="required" placeholder="Nama Orang" name="nama" value="<?php echo $data['nama']; ?>">
                    </div>
                  </div><br><br><br>
                  <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Job</label>
                    <div class="col-md-9 col-sm-9 col-xs-12">
                      <input type="text" class="form-control" required="required" placeholder="Bidang Pekerjaan" name="job" value="<?php echo $data['job']; ?>">
                    </div>
                  </div><br><br><br>
                  <div class="form-group">
                  ...
                  <textarea name="des" class="ckeditor" id="ckeditor"><?php echo $data['des']; ?></textarea>             
                  <br />
