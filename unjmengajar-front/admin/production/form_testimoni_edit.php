  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
        ...
        $show = mysql_query("SELECT * FROM testimoni WHERE id='$id'");
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="x_content">
                  <form action="edit_testimoni.php" method="post">
                  <input type="hidden" name="id" value="<?php echo $id; ?>">
                  <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Judul</label>
                    <div class="col-md-9 col-sm-9 col-xs-12">
                      <input type="text" class="form-control" required="required" placeholder="Judul Testimoni" name="judul" value="<?php echo $data['judul']; ?>">
                    </div>
                  </div><br><br><br>
                  <div class="form-group">
