                      ...
                      <tbody>
                        ...
                        while($data = mysql_fetch_assoc($query)){
                          ...
                          echo  '<tr>
                                  ...
                                  <td><center>
                                        <a href="form_testimoni_edit.php?id='.$data['id'].'" data-toggle="tooltip" title="Edit" class="btn btn-sm btn-warning"> <i class="fa fa-pencil"></i> </a>
                                        <a href="delete_testimoni.php?id='.$data['id'].'" data-toggle="tooltip" title="Hapus" class="btn btn-sm btn-danger" onclick="return confirm(\'Yakin?\')"> <i class="fa fa-trash"></i> </a>
                                      </center></td>
                                </tr>';
                            }
                          }
