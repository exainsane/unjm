          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="x_content">
                  <form enctype="multipart/form-data" action="add_team.php" method="post">
                  <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Nama</label>
                    <div class="col-md-9 col-sm-9 col-xs-12">
                      <input type="text" class="form-control" required="required" placeholder="Nama Orang" name="nama">
                    </div>
                  </div><br><br><br>
                  <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Job</label>
                    <div class="col-md-9 col-sm-9 col-xs-12">
                      <input type="text" class="form-control" required="required" placeholder="Bidang Pekerjaan" name="job">
                    </div>
                  </div><br><br><br>
                  <div class="form-group">
                  ...
                  <textarea name="des" class="ckeditor" id="ckeditor"></textarea>             
                  <br />
