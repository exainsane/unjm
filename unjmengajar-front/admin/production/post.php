                ...
                <div class="x_content">
                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        ...
                        include('koneksi.php');         
                        $query = mysql_query("SELECT * FROM blog") or die(mysql_error());
                        if(mysql_num_rows($query) == 0){
                          echo '';            
                        }else{
                        while($data = mysql_fetch_assoc($query)){
                          $limited_string = limit_words($data['des'], 10);
                          echo  '<tr>
                                  <td>'.$data['judul'].'</td>
                                  <td>'.$limited_string.'</td>
                                  <td><center>
                                        <a href="form_post_edit.php?id='.$data['id'].'" data-toggle="tooltip" title="Edit" class="btn btn-sm btn-warning"> <i class="fa fa-pencil"></i> </a>
                                        <a href="delete_post.php?id='.$data['id'].'" data-toggle="tooltip" title="Hapus" class="btn btn-sm btn-danger" onclick="return confirm(\'Yakin?\')"> <i class="fa fa-trash"></i> </a>
                                      </center></td>
                                </tr>';
                            }
                          }
