      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="x_content">
          ...
          <div class="form-group">
            ...
            <div class="col-md-9 col-sm-9 col-xs-12">
              <input type="text" class="form-control" required="required" placeholder="Bidang Pekerjaan" value="<?php echo $job ?>" name="form-job">
            </div>
          </div><br><br><br>
          <div class="form-group">
            <input type="hidden" value="<?php echo $img ?>" name="old-form-img">
